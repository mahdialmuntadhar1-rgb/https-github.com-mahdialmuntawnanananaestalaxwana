...
export const api = {
  ...
  async getOrCreateProfile(authUser: { id: string; email?: string | null; user_metadata?: Record<string, any>; email_confirmed_at?: string | null }, requestedRole: 'user' | 'owner' = 'user') {
